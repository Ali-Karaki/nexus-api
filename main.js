const data = {
  ...
  feed_url: 'https://www.citizenscience.gov/feed.json',
  expired: false,
  _project: [
    {
      project_id: '3',
...

    {
      ...
      keywords:
        'seabirds, citizen science, coast, beaches, marine environment, surveys',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'National Oceanic and Atmospheric Administration (NOAA), National Science Foundation (NSF), U.S. Fish and Wildlife Service',
      agency_sponsor_other: 'NOAA Olympic Coast National Marine Sanctuary',
      geographic_scope: 'Regional',
      participant_age: 'families, general_public, seniors, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, measurement, observation, photography, problem_solving',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Citizen Science, DISCOVER-AQ, low-cost sensors, CairClip, ozone, nitrogen dioxide',
      fields_of_science: 'Ecology and environment',
      project_status: 'complete',
      agency_sponsor:
        'U.S. Environmental Protection Agency (EPA),  National Aeronautics and Space Administration (NASA), National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, measurement, observation, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Aquatic species, Freshwater organisms, Invasive species, Nonnative, Nonindigenous, Plants',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Fish and Wildlife Service, National Science Foundation (NSF), National Park Service (NPS)',
      agency_sponsor_other: 'NOAA, NASA',
      geographic_scope: 'National',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'geolocation, observation, photography, specimen_sample_collection, identification, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'http://www.aquariumofpacific.org/conservation/sea_turtle_monitoring',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, data_entry, observation',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Antarctica, penguin, Commission for the Conservation of Antarctic Marine Living Resources, Antarctic Treaty Consultative Meeting, Scientific Committee for Antarctic Research',
      fields_of_science:
        'Animals, Biology, Birds,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
...

    {
      ...
      keywords:
        'Environmental Justice, Sustainability, GIS, Mapping, C-FERST, Crowdsourcing, Citizen Science, Education, Community Exposure, Human Exposure Models, Environmental Stressors',
      fields_of_science:
        'Computers and technology,  Ecology and environment,  Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, data_entry, geolocation, identification, learning, measurement, observation, photography, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Birds,  ecology, environment, urbanization, urban ecology, avian survival, backyard birds, nest, nesting success, underserved elementary schools',
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Education, Nature and outdoors, Social science',
      project_status: 'active',
      agency_sponsor:
        'Smithsonian Institution (SI), National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'National',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, seniors, teens',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, finding_entities, geolocation, identification, learning, measurement, observation, problem_solving',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'urban pollinator conservation, partnership, mapping, native species, education',
      fields_of_science:
        'Biology, Ecology and environment,  Education, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'U.S. Forest Service (USFS), U.S. Department of Agriculture',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, finding_entities, identification, learning, observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'http://www.naturemappingjh.org/Gros-Ventre-Project.aspx',
      project_description:
...

    {
      ...
      fields_of_science:
        'Biology, Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, learning, measurement, photography',
      scistarter: 'true',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'U.S. Department of the Interior (DOI), U.S. Geological Survey (USGS), National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'National',
      participant_age:
        'families, general_public, middle_school_children, seniors, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, finding_entities, geolocation, identification, learning, measurement, observation, photography, problem_solving, site_selection_description, specimen_sample_collection, transcription',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'geolocation, identification, learning, observation, other, photography',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://montereybay.noaa.gov/getinvolved/volunteer/urbanwatch.html',
      project_description:
      ...
      fields_of_science:
        'Chemistry,  Climate and weather,  Ecology and environment,  Education, Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Regional',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, identification, learning, measurement, observation, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://montereybay.noaa.gov/getinvolved/volunteer/firstflush.html',
      project_description:
      ...
      keywords:
        'storm water, sampling, water sampling, pollutants, urban, storm drain, citizen science, volunteers,',
      fields_of_science:
        'Chemistry,  Climate and weather,  Ecology and environment',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, learning, measurement, observation, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
      email: 'Lisa.Emanuelson@noaa.gov',
      start_date: '9/1/2000',
    },

    {
      ...
      fields_of_science:
        'Animals, Biology, Pollinators/insects, Nature and outdoors',
      project_status: 'complete',
      agency_sponsor:
        'U.S. Forest Service (USFS), U.S. Department of Agriculture',
      ...
      geographic_scope: 'International',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, identification, observation, photography, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'https://www.adventurescientists.org/uinta-carnivore-survey.html',
      project_description:
      ...
      keywords:
        'wildlife, adventure science, citizen science, wolverine, canada lynx, United States Forest Service, Adventurers and Scientists for Conservation, National Forest Foundation',
      fields_of_science:
        'Animals, Ecology and environment,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor:
...

    {
      ...
      keywords:
        'Animal count, Animal survey, Avian Biology, Animal survey, BioGeography,  Biology, birds, Bird abundance, Bird community, Bird count, Bird data, Bird diversity, Bird survey, Citizen science, Ecology, Hierarchical model, Index to abundance, Index survey, Ornithology, Point count, Population dynamics, Population increase, Population decline, Population change, Population modeling, Population trends, Range map, Relative abundance, Trend analysis, Wildlife count, Wildlife survey',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Fish and Wildlife Service, Bureau of Land Management (BLM), National Park Service (NPS)',
      agency_sponsor_other:
        'USDA, (CAN) Environment and Climate Change Canada, (MEX) National Commission for Knowledge and Use of Biodiversity',
      geographic_scope: 'United States, Canada, Mexico',
      participant_age: 'targeted_group, general_public',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification, learning, measurement, observation ',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'international collaboration, education, student science, earth science, community science, global community, clouds, mosquitos, mosquito-borne disease, land cover',
      fields_of_science:
        'Biology, Chemistry,  Climate and weather,  Ecology and environment,  Geology and earth science,  Geography,  Nature and outdoors, Computers and technology',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other:
        'National Oceanic and Atmospheric Administration (NOAA), National Science Foundation (NSF), Department of State',
      geographic_scope: 'International',
      participant_age:
        'elementary_school_children, middle_school_children, families,  general_public, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, geolocation, identification, learning, measurement, observation, photography, problem_solving, sample_analysis, specimen_sample_collection, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Astronomy and space, Geology and earth science,  Nature and outdoors, Physics, Transportation',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'International',
...

    {
      ...
      keywords:
        'Space Weather, aurora borealis, Ground Truthing, Mobile Application, natural phenomena',
      fields_of_science:
        'Astronomy and space, Climate and weather,  Nature and outdoors, Physics, Computers and technology',
      project_status: 'active',
      agency_sponsor:
      ...
      project_goals: '',
      participation_tasks:
        'Observation, Classification, Geolocation, Identification, Photography',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Volunteer, Community Practice, Water Quality Monitoring, Biology, Education, Youth Involvement, Standards, Environmental Monitoring, Fish and Wildlife Service (FWS)',
      fields_of_science:
        'Animals, Biology, Chemistry,  Ecology and environment,  Education, Geology and earth science,  Pollinators/insects, Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'Idaho',
      participant_age:
        'elementary_school_children, families, middle_school_children, general_public, seniors, teens',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification, learning, measurement, observation, photography, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'birds, Costa Rica, phenology, Monteverde, Rocky Mountain National Park, climate change',
      fields_of_science:
        'Animals, Birds,  Ecology and environment,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Rocky Mountain National Park',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), National Park Service (NPS)',
...

    {
      ...
      keywords:
        'cloud observation, satellite comparison, cloud science, ground truth, NASA',
      fields_of_science: 'Climate and weather',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, learning, measurement, observation, photography',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Air quality, Newark, community justice, environmental justice, EPA, ICC, equipment lending, sensors',
      fields_of_science: 'Ecology and environment',
      project_status: 'complete',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'Renewable Energy, National Laboratory, Open Source, crowdsourcing, Solar',
...

    {
      ...
      keywords:
        'Climate Data, Weather observation, historical records, volunteer data,',
      fields_of_science: 'Climate and weather',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, finding_entities, geolocation, identification, observation',
      scistarter: 'true',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'Bureau of Land Management (BLM), National Oceanic and Atmospheric Administration (NOAA), National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'National',
      participant_age:
        'elementary_school_children, middle_school_children, general_public, teens',
      project_goals: '',
...

    {
      ...
      keywords:
        'policy, prediction market, combinatorics, Bayesian networks, Markov engines, George Mason University, forecasting, iarpa,',
      fields_of_science:
        'Computers and technology,  Science policy, Social science',
...

    {
      ...
      keywords:
        'Conservation, Ecosystem Ecology, Research, Public Participation, Environmental Monitoring, sample collection',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors, Ocean/water and marine',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Regional',
...

    {
      ...
      fields_of_science:
        'Biology, Chemistry,  Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Regional',
...

    {
      ...
      project_url_external:
        'http://products.coastalscience.noaa.gov/values_survey/',
      project_description:
      ...
      fields_of_science:
        'Ecology and environment,  Nature and outdoors, Ocean/water and marine, Psychology',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other:
        "NOAA Gray's Reef National Marine Sanctuary, NOAA Sapelo Island NERR, NCCOS Hollings Marine Labratory",
      geographic_scope: 'Local',
      participant_age: 'general_public',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'http://graysreef.noaa.gov/involved/volunteer/team_ocean.html',
      project_description:
      ...
      keywords:
        'scuba dive, habitat mapping, fish count, fish id, marine debris, survey',
      fields_of_science:
        'Animals, Archeology and cultural, Biology, Ecology and environment,  Geology and earth science,  Nature and outdoors, Ocean/water and marine, Physics',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other:
        'NOAA Office of National Marine Sanctuaries, NOAA Dive Program',
      geographic_scope: 'Regional',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'audio_video_recording, classification_tagging, finding_entities, geolocation, identification, measurement, observation, other, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
      email: 'jody.patterson@noaa.gov',
...

    {
      ...
      keywords:
        'Volunteer Monitoring, Oceanography, Public Awareness, Biotoxins, Harmful Algal Blooms',
      fields_of_science:
        'Animals, Biology, Chemistry,  Climate and weather,  Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'National',
...

    {
      ...
      project_url_external:
        'http://stem.svvsd.org/plains-park-student-research-project',
      project_description:
      ...
      keywords:
        'Plains to the park, STEM, education, middle school, place, engagement, science literacy, video',
      fields_of_science:
        'Climate and weather,  Ecology and environment,  Education, Nature and outdoors',
      project_status: 'complete',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Rocky Mountain National Park',
...

    {
      ...
      keywords:
        'Conservation, Research, Integrated Resource Management, Environmental Awareness, public participation, community engagement',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Geology and earth science,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Regional',
...

    {
      ...
      keywords:
        'intertidal monitoring, students, teachers, sandy beach, rocky intertidal',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, learning, measurement, observation, photography',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://sanctuarysimon.org/news/2015/08/whale-sightings-in-the-northern-channel-islands/',
      project_description:
      ...
      keywords:
        'endangered whales, whale alert, spotter pro, blue whale, humpback whale, photo-ID',
      fields_of_science:
        'Animals, Biology, Climate and weather,  Ecology and environment,  Nature and outdoors, Science policy',
      project_status: 'active',
      agency_sponsor:
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, observation, photography',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Climate Change, Sea Ice, Native American, Food Security, Costal Communities, Research',
      fields_of_science:
        'Animals, Biology, Climate and weather,  Ecology and environment,  Food,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active_but_seasonal',
      agency_sponsor:
        'National Oceanic and Atmospheric Administration (NOAA), National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'Aerial photographs, Coastal change, Coastal hazards, Natural hazards, Oceanography, Geomorphology',
      fields_of_science:
        'Geology and earth science,  Climate and weather,  Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, photography, learning, observation, identification',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, finding_entities, geolocation, identification, learning, measurement, observation, photography, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Loon, Loons, Common Loon, Glacier, Glacier National Park, National Park, Glacier Park, NPS, Park, Parks, National Park Service, Montana, Gavia immer',
      fields_of_science:
        'Animals, Biology, Birds,  Ecology and environment,  Education, Nature and outdoors',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Park Service (NPS)',
...

    {
      ...
      keywords:
        'Goat, Goats, Sheep, Mountain Goat, Mountain Goats, Bighorn Sheep, Pika, Pikas, Ochotona princeps, Ovis canadensis, Oreamnos americanus, Glacier, Glacier National Park, Glacier Park, National Park, NPS, Park, Parks, National Park Service, Montana',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Nature and outdoors',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Glacier National Park',
...

    {
      ...
      project_url_external:
        'http://en.openei.org/doe-opendata/dataset/utility-outage-information',
      project_description:
      ...
      keywords:
        'Department of Energy, DOE, Disaster response,  gas stations, power outage, crowdsourcing',
...

    {
      ...
      keywords:
        'Information Technology, Connectivity, Internet, Computer Technology, National Planning, Infrastructure, Public-Private Partnership, Open Access, Broadband',
      fields_of_science:
        'Computers and technology,  Science policy, Social science, Disaster response',
      project_status: 'active',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, measurement, site_selection_description, download_sw',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Computers and technology,  Disaster response,  Education',
      project_status: 'active',
      agency_sponsor:
        'Department of State,  U.S. Agency for International Development (USAID), Peace Corps',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      participant_age: 'general_public',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'https://www.noaa.gov/office-education/elp/grants/awards?search_api_views_fulltext=NA09SEC4690039',
      project_description:
...

    {
      ...
      project_url_external:
        'https://sservi.nasa.gov/lunar-and-planetary-mapping-and-modeling/',
      project_description:
      ...
      keywords:
        'Space, Moon, Mars, Vesta, Asteroids, Mapping, Planetary Science, Lunar Science, Mission Planning Virtual, Crowdsourcing, NASA',
      fields_of_science: 'Astronomy and space, Computers and technology',
      project_status: 'active',
      agency_sponsor:
        'National Aeronautics and Space Administration (NASA), U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      participant_age:
        'general_public, teens, middle_school_children, elementary_school_children, families, targeted_group',
      project_goals: '',
      participation_tasks:
        'diy_hacking_making, geolocation, learning, measurement, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'right whales, conservation, management, citizen science, sightings, opportunistic reports',
      fields_of_science:
        'Animals, Biology, Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Regional',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, identification, learning, observation, photography',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://stellwagen.noaa.gov/involved/vol_facts.html',
      project_description:
      ...
      keywords:
        'seabirds, citizen science, research, monitoring, data collection, ocean, wildlife',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Education, Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Local',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, audio_video_recording, classification_tagging, data_analysis, data_entry, finding_entities, identification, observation, photography',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'parasite, invasive species, Chesapeake Bay, ecology, environmental science, marine science, crab',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'Smithsonian Institution (SI)',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, measurement,  observation, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Viriginia, grasslands, biodiversity, habitat monitoring, bees, pollinators, birds, riparian, salamander, stream, landowner, forest',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Education, Nature and outdoors, Pollinators/insects, Science policy',
      project_status: 'active',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, learning,  observation, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      geographic_scope: 'International',
      participant_age:
        'families, general_public, middle_school_children, targeted_group, teens, Other',
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_entry, geolocation',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'climate change, wetlands, salt marsh, plants, nutrients, carbon dioxide, invasive species, environmental science, biogeochemistry',
      fields_of_science:
        'Biology, Chemistry,  Climate and weather,  Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other:
        'National Science Foundation, US Department of Energy, US Geological Survey, NASA, NOAA/Maryland Sea Grant',
      geographic_scope:
        'Chesapeake Bay, Maryland (on campus of Smithsonian Environmental Research Center)',
      participant_age: 'families, general_public, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, measurement,  observation, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
      email: 'cawooda@si.edu',
...

    {
      ...
      keywords:
        'environmental archaeology, history, Maryland, Chesapeake Bay, excavation, artifact',
      fields_of_science:
        'Archeology and cultural, Climate and weather,  Ecology and environment,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      geographic_scope:
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_analysis, data_entry, identification, learning, measurement,  observation, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
      email: 'cawooda@si.edu',
      start_date: '2012-01-01',
    },

    {
      ...
      keywords:
        'plant, leaf, tree, forest, woods, park, flower, identification, maps',
      fields_of_science:
        'Biology, Climate and weather,  Ecology and environment,  Education, Geography,  Nature and outdoors, Pollinators/insects',
      project_status: 'complete',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, finding_entities, geolocation, identification, learning,  observation',
      scistarter: 'true',
      email: 'kressj@si.edu',
      start_date: '2010-01-01',
    },
...

    {
      ...
      keywords:
        'Moon, Planets, Planetary Science, Geology, Astronomy, Space Exploration',
      fields_of_science: 'Astronomy and space',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      geographic_scope: 'World',
      participant_age:
        'elementary_school_children, general_public, middle_school_children, teens',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'http://cosmoquest.org/?application=mercury_simply_craters',
...

    {
      ...
      project_url_external:
        'http://cosmoquest.org/?application=mars_simply_craters',
      project_description:
...

    {
      ...
      keywords:
        'Asteroids, Planets, Planetary Science, Geology, Astronomy, Space Exploration',
      fields_of_science: 'Astronomy and space',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'weather, climate change, seasonal cycles, citizen science, weather journal, weather, crowdsourcing, weather recordkeeping, climate change, adaptation, community, conservation, climate change monitoring, climate change activism, seasonal cycles, tracking, carbon climate change satellite, carbon climate change data, community based data, climate change public data, carbon climate change monitoring',
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Nature and outdoors, Ocean/water and marine, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'National Aeronautics and Space Administration (NASA), National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, geolocation, identification,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/rlc/continentaldivide/parksandpartners.htm',
      project_description:
      ...
      keywords:
        'STEM education, Costa Rica, students, exchange, national parks',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Education, Nature and outdoors',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'observation, site_selection_description, classification_tagging, data_entry, geolocation, identification, photography',
      scistarter: 'true',
      email: 'baum@usgs.gov',
      start_date: '2012',
    },

    {
      ...
      project_url_external:
        'http://www.nps.gov/romo/naturescience/rocky-mountain-butterfly-project.htm',
      project_description:
      ...
      keywords:
        'butterfly, monitoring, systematic survey, replication, national parks',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Pollinators/insects, Nature and outdoors',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Rocky Mountain National Park',
...

    {
      ...
      keywords:
        'hummingbirds, birds, national parks, citizen science, in-kind support',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor:
        'National Park Service (NPS), U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'Rocky Mountain National Park',
      participant_age: '',
      project_goals: '',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope:
        'Regional (Iowa, Michigan, Nebraska, New York, Oregon, Utah, Wisconsin) but will be National',
      participant_age:
        'elementary_school_children, families, middle_school_children, general_public, seniors, teens',
      project_goals: '',
      participation_tasks:
        'measurement, site_selection_description, data_entry',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Biology, Chemistry,  Climate and weather,  Computers and technology,  Ecology and environment,  Education, Geology and earth science,  Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'South Valley, Bernalillo County, Albuquerque, NM',
      participant_age:
        'elementary_school_children, general_public, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, learning, measurement,  observation, problem_solving, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://www.ars.usda.gov/Research/docs.htm?docid=25733',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Education, Food,  Geography,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'U.S. Department of Agriculture, U.S. Geological Survey (USGS)',
      agency_sponsor_other:
        'USDA Agricultural Research Service (USDA-ARS), USDA National Institute of Food and Agriculture (USDA-NIFA)',
      geographic_scope: 'Norther Plains',
      participant_age: 'targeted_group',
      project_goals: '',
      participation_tasks:
        'learning, measurement,  observation, problem_solving',
      scistarter: 'false',
...

    {
      ...
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, finding_entities, identification, learning, observation, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Chemistry,  Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Education, Geography,  Geology and earth science,  Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'complete',
      agency_sponsor:
        'National Park Service (NPS), U.S. Fish and Wildlife Service, U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Albuquerque MS4 watershed/Middle Rio Grande Urban Waters Federal Partnership designated area, New Mexico',
      participant_age:
        'elementary_school_children, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'data_analysis, finding_entities, identification, learning, measurement,  observation, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
      email: '',
...

    {
      ...
      fields_of_science:
        'Computers and technology,  Disaster response,  Geology and earth science',
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), National Science Foundation (NSF)',
      agency_sponsor_other:
        'Southern California Earthquake Center (NSF/USGS Funded organization), Incorporated Research Institutions for Seismology (NSF funded)',
      geographic_scope: 'International',
      participant_age: 'general_public',
      project_goals: '',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_entry, finding_entities, geolocation, identification, learning,  observation, Other',
      scistarter: 'true',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Locals areas in Washington DC, Arlington VA, and Baltimore MD',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
...

    {
      ...
      keywords:
        'Missing, Exploited, Children, Child, Predator, Sexual Abuse, Pornogrpahic Activity',
...

    {
      ...
      project_url_external:
        'http://www.nps.gov/noca/getinvolved/supportyourpark/butterfly-project.htm',
      project_description:
      ...
      keywords:
        'butterfly, insect, climate change, national parks, photo-inventories, butterfly transects',
      fields_of_science: 'Animals, Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'U.S. Forest Service (USFS), National Park Service (NPS), U.S. Department of Agriculture',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'data_entry, finding_entities, geolocation, identification,  observation, photography',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'eyewire, game, connectome, biomedical, puzzle, brain, neuron, retina',
...

    {
      ...
      keywords:
        'innovation, crowdsourcing, genomics, informatics, precision medicine',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, identification, measurement, problem_solving, sample_analysis, Other',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Genomics, Foodborne illness, pathogen surveillance, Whole Genome Sequencing, Salmonella, Listeria',
      fields_of_science:
        'Biology, Computers and technology,  Health and medicine',
      project_status: 'active',
      agency_sponsor:
        'Food and Drug Administration, National Institutes of Health (NIH), Center for Disease Control, U.S. Department of Agriculture',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      participant_age: 'Other',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, download_sw, geolocation, identification, learning, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, learning, measurement,  observation, problem_solving, sample_analysis',
      scistarter: 'false',
      email: 'zmo2@cdc.gov',
      start_date: '2013',
    },

    {
      ...
      project_url_external:
        'https://www.cdc.gov/ddphss/chiic/projects/2015/ideas/operation-dragon-fire-odf.html',
      project_description:
      ...
      keywords:
        'Information datasource; information sharing, cooridination and collaboration',
...

    {
      ...
      keywords:
        'Zika, Dengue, Chikungunya; mosquitos; vector-borne diseases; Aedes aegypti; surveillance',
      fields_of_science: 'Health and medicine',
      project_status: 'complete',
      agency_sponsor: 'Center for Disease Control',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'biodiversity, species, checklist, field guide, encyclopedia, animals, birds, plants, mammals, ambphibians, reptiles, fishes, invertebrates, crustaceans, mullusks, insects, spiders, worms, flowers, trees, fungi, mushrooms, molds, bacteria, algae, protists, protozoa, archaea, viruses',
      fields_of_science:
        'Animals, Biology, Birds,  Ecology and environment,  Education, Nature and outdoors, Ocean/water and marine, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      geographic_scope: 'World',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, audio_video_recording, classification_tagging, diy_hacking_making, identification, learning,  observation, photography, transcription',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'camera trapping, mammals, wildlife, conservation, biodiversity, ecology, animals, biology',
      fields_of_science:
        'Animals, Biology, Birds,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'Smithsonian Institution (SI)',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, audio_video_recording, classification_tagging, diy_hacking_making, data_analysis, data_entry, finding_entities, geolocation, identification, learning,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Ecology and environment,  Geography,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other:
        'In its early years (2007 - 2010), Project BudBurst received funding from US Fish and Wildlife ServiceS; US Bureau of Land Management, US Forest Service, and US Geological Survey.',
      geographic_scope: 'National',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification,  observation',
      scistarter: 'true',
      email: '',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, learning, measurement,  observation, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Animals, Archeology and cultural, Astronomy and space, Biology, Chemistry,  Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Education, Geography,  Geology and earth science,  Health and medicine,  Nature and outdoors, Ocean/water and marine, Physics, Pollinators/insects, Psychology, Social science, Transportation',
      project_status: 'active',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, diy_hacking_making, data_analysis, finding_entities, geolocation, identification, learning,  observation, problem_solving, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.usgs.gov/natural-hazards/earthquake-hazards/science/tweet-earthquake-dispatch?qt-science_center_objects=0#qt-science_center_objects',
      project_description:
      ...
      keywords:
        'Twitter, social media, data mining, crowdharvesting, citizen seismology',
      fields_of_science:
        'Computers and technology,  Disaster response,  Geology and earth science',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope:
        'International where people use Twitter and feel earthquakes',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Biology, Ecology and environment,  Pollinators/insects',
      project_status: 'pending',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, identification, measurement,  observation, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Computers and technology,  Ecology and environment,  Geology and earth science,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      ...
      project_goals: '',
      participation_tasks:
        'data entry, geolocation, learning, measurement, sample analysis, site selection description, specimen sample collection.',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Climate and weather,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope:
        'Baldcypress swamps along the Mississippi River Alluvial Valley in Illinois, Tennessee, Arkansas, Mississippi, Louisiana, Texas, Delaware, Maryland, and Florida; Gulf Coast in Texas, Louisiana and Florida; Atlantic Coast in Maryland and Delaware.',
      participant_age: 'general_public, teens',
      project_goals: '',
      participation_tasks:
        'specimen_sample_collection, geolocation, observation, site_selection_description, photography, measurement, learning',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Birds,  Climate and weather,  Computers and technology,  Ecology and environment,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Department of the Interior (DOI)',
      agency_sponsor_other: '',
      geographic_scope: 'United States',
      participant_age: 'targeted_group, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, learning,  observation, photography, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Fish and Wildlife Service',
      agency_sponsor_other: 'Canadian Wildlife Service',
      geographic_scope: 'United States and Canada',
      participant_age: 'general_public, targeted_group, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification,  observation, specimen_sample_collection, transcription',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'https://www.usgs.gov/media/files/adopt-a-pixel-directions',
      project_description:
      ...
      keywords:
        'Landscape photographs, Land cover, Ground-based landscape data',
      fields_of_science:
        'Astronomy and space, Geography,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
      ...
      project_goals: '',
      participation_tasks:
        'geolocation, identification,  observation, photography, site_selection_description, Other',
      scistarter: 'true',
...

    {
      ...
      geographic_scope:
        'International but focus is on US and particularly Alaska, California, Nevada, Hawaii, Haiti, and Eurasia',
      participant_age: 'general_public, targeted_group, Other',
      project_goals: '',
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Department of Agriculture',
      agency_sponsor_other: '',
      geographic_scope: 'United States',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'data_entry, identification,  observation, photography, site_selection_description, specimen_sample_collection, Other',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Birds,  Disaster response,  Ecology and environment,  Health and medicine,  Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor:
        'U.S. Fish and Wildlife Service, National Park Service (NPS), U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope:
        'United States Atlantic coastline including New England, New York, New Jersey, South Carolina, Georgia, and Florida',
      participant_age: 'general_public, families, targeted_group',
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, observation, photography, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'United States (Over 20 states in eastern and central time zones)',
      participant_age: 'general_public, teens',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification, learning, measurement,  observation, specimen_sample_collection, Other',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Computers and technology,  Ecology and environment,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'download_sw, geolocation,  observation, photography, site_selection_description',
      scistarter: 'true',
      email: 'sdroege@usgs.gov',
      start_date: '2014',
    },

    {
      ...
      keywords:
        'wildlife, disease, Great Lakes, avian botulism, waterbirds, GLRI',
      fields_of_science:
        'Animals, Birds, Ecology and environment,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other:
        "Program headed by USGS National Wildlife Health Center with funds from EPA's Great Lakes Restoration Initiative",
      geographic_scope: 'Lake Michigan shoreline',
      participant_age: 'general_public, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification,  observation, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://www.gcmrc.gov/research_areas/food_base/citizen_science_monitoring.aspx',
      project_description:
      ...
      fields_of_science:
        'Animals, Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, identification, learning, measurement,  observation, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.usgs.gov/centers/fort/science/sciencecache?qt-science_center_objects=0#qt-science_center_objects',
      project_description:
      ...
      keywords:
        'huckleberry, national park, geocache, mobile app, photography, phenology, NPN',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Food,  Nature and outdoors, Pollinators/insects',
      project_status: 'pending',
      agency_sponsor: 'U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'United States',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification, measurement,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Health and medicine,  Nature and outdoors, Ocean/water and marine',
      project_status: 'hiatus',
      agency_sponsor:
        'U.S. Geological Survey (USGS), U.S. Fish and Wildlife Service',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, learning,  observation, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'geolocation, identification, learning,  observation, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'whale alert, citizen science, sightings, right whale, conservation, management',
      fields_of_science:
        'Animals, Biology, Computers and technology,  Ecology and environment,  education, Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'International',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, finding_entities, identification, learning, observation, photography',
      scistarter: 'false',
...

    {
      ...
      agency_sponsor: 'U.S. Department of Agriculture',
      agency_sponsor_other:
        'USDA Animal and Plant Health Inspection Service (USDA-APHIS), USDA Veterinary Services (USDA-VS)',
      geographic_scope: 'National',
      participant_age: 'general_public',
      project_goals: '',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry,  observation, Other',
      scistarter: 'false',
...

    {
      ...
      project_status: 'active_but_seasonal',
      agency_sponsor:
        'U.S. Forest Service (USFS), U.S. Department of Agriculture, National Park Service (NPS)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'brown marmorated stink bug, invasive species, biological control, integrated pest management, egg parasitoids, crop damage, household insect invaders',
      fields_of_science:
        'Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'U.S. Department of Agriculture',
      agency_sponsor_other:
...

    {
      ...
      project_url_external:
        'https://urbanforestry.indiana.edu/projects/past-projects/nucfac/index.html',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, learning, measurement',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'mining, metal contamination, citizen science, community engagement, garden',
      fields_of_science:
        'Ecology and environment,  Education, Geology and earth science,  Health and medicine,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor: 'National Institutes of Health (NIH)',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, learning, measurement, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'PAHs, longitudinal cohort, seafood contamination, Gulf Oil Spill',
      fields_of_science:
        'Biology, Chemistry,  Ecology and environment,  Health and medicine',
      project_status: 'active',
      agency_sponsor: 'National Institutes of Health (NIH)',
      agency_sponsor_other: '',
      geographic_scope: 'regional',
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Geology and earth science,  Health and medicine,  Nature and outdoors',
      project_status: 'complete',
      agency_sponsor: 'National Institutes of Health (NIH)',
      agency_sponsor_other: '',
      geographic_scope: 'local',
...

    {
      ...
      keywords:
        'New York City, trees, urban greening,urban forest,  urban ecology',
      fields_of_science:
        'Biology, Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
...

    {
      ...
      keywords:
        'brown pelican, citizen science, birds, pacific coast, channel islands',
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Fish and Wildlife Service',
      agency_sponsor_other: '',
      geographic_scope:
        'Pacific coastline including 113 sites across Oregon, Washington and California',
      participant_age: 'general_public, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, measurement,  observation, photography, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Red Knot, shorebird, wader, horseshoe crab, monitoring, Delaware',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Health and medicine,  Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'Active',
      agency_sponsor: 'U.S. Fish and Wildlife Service',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_entry, finding_entities, identification, learning, measurement, observation, sample_analysis, specimen_sample_collection, transcription, other',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'http://www.sdnhm.org/science/birds-and-mammals/projects/flying-squirrel-study/',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, finding_entities, photography, Other',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Archeology and cultural, Astronomy and space, Biology, Chemistry,  Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Education, Food,  Geography,  Geology and earth science,  Health and medicine,  Physics, Psychology, Social science, Transportation',
      project_status: 'active',
      agency_sponsor: 'Department of Defense (DOD)',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, identification, problem_solving',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'NGLY1, annotation, biomedical, literature, scientific communication',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_analysis, learning',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'DNA Barcode, Barcode Long Island, Student Initiated Research, biodiversity',
      fields_of_science:
        'Biology, Climate and weather,  Ecology and environment,  Education, Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Institutes of Health (NIH)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, learning, measurement, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Environmental Justice, Children’s Environmental Health, GIS, Mapping, C-LINE, C-FERST, Citizen Science, education, Community Engagement, Air Quality, EnviroAtlas, Air Pollution',
      fields_of_science:
        'Computers and technology,  Ecology and environment,  Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, data_entry, geolocation, learning, measurement, observation, photography, problem_solving, sample_analysis, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'asteroid, near-Earth asteroid, telescope, citizen science, Target Asteroids, target NEOs, OSIRIS-REx, CCD imaging, amateur astronomy, pro-am collaboration, photometry, astrometry, solar system, astronomical imaging, observatory',
      fields_of_science: 'Astronomy and space',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Disaster response,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'Ocean, Water, and Marine, Water quality, Lakes, Toxicity, aviation, pilots, citizen science',
      fields_of_science: 'Climate and weather,  Ecology and environment',
      project_status: 'active',
      agency_sponsor:
        'National Aeronautics and Space Administration (NASA), U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'United States',
      participant_age: 'general_public, targeted_group',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, geolocation,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'identification, learning,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'cyanobacteria, harmful algal blooms, cyanotoxins, HAB monitoring',
      fields_of_science: 'Biology, Ecology and environment,  Education',
      project_status: 'active',
      agency_sponsor:
        'U.S. Environmental Protection Agency (EPA), U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      geographic_scope: 'regional/national',
      participant_age:
        'general_public, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, finding_entities, geolocation, identification, learning, measurement,  observation, photography, problem_solving, sample_analysis',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Agroecology, land use change, climate, extreme weather, wildlife, conservation',
      fields_of_science:
        'Climate and weather,  Ecology and environment,  Geography',
      project_status: 'active',
      agency_sponsor:
        'U.S. Department of Agriculture, National Oceanic and Atmospheric Administration (NOAA), National Science Foundation (NSF)',
      agency_sponsor_other:
        'USDA National Institute of Food and Agriculture (USDA-NIFA)',
      geographic_scope: 'National',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation,  observation, photography, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Biodiversity, native bees, organic, pollination services, pollinator',
      fields_of_science: 'Food,  Pollinators/insects',
      project_status: 'complete',
      agency_sponsor:
        'U.S. Department of Agriculture, National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Western Washington State',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'data_entry, identification, measurement,  observation',
      scistarter: 'true',
...

    {
      ...
      keywords: 'mosquito',
      fields_of_science:
        'Biology, Education, Health and medicine,  Pollinators/insects',
      project_status: 'pending',
      agency_sponsor: 'U.S. Department of Agriculture',
      ...
      project_goals: '',
      participation_tasks:
        'identification, learning, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'http://articles.extension.org/pages/61320/broodmapper:-honey-bee-development-and-citizen-science',
      project_description:
      ...
      keywords:
        'honey bee, bumble bee, squash bee, alfalfa leafcutter bee, pesticide, insecticide, fungicide, toxicology, queen, larva',
...

    {
      ...
      keywords:
        "Food safety, local growing, organic food, healthy eating, vegetable gardens, heirloom varieties, delicious recipes, home canning, pollinators, apiary, farmer's markets",
      fields_of_science:
        'Biology, Chemistry,  Ecology and environment,  Education, Food,  Health and medicine,  Nature and outdoors, Pollinators/insects, Social science',
      project_status: 'active',
      agency_sponsor: 'U.S. Department of Agriculture',
      agency_sponsor_other:
        'USDA Agricultural Marketing Service (USDA-AMS), USDA Natural Resources Conservation Service (USDA-NRCS), USFS',
      geographic_scope: 'International',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'identification, learning, measurement,  observation, specimen_sample_collection, Other',
      scistarter: 'false',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, measurement,  observation, Other',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'NRCS Snow Survey, measuring snow courses, sample collection, data entry, geolocation',
      fields_of_science:
        'Climate and weather,  Computers and technology,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Department of Agriculture',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, measurement, sample_analysis',
      scistarter: 'false',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'U.S. Geological Survey (USGS), Department of Defense (DOD)',
      agency_sponsor_other:
        'U.S. Army Corps of Engineers (USACE), National Biological Survey, National Wildlife Federation',
      geographic_scope: 'United States',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, identification, learning, measurement,  observation, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, finding_entities, geolocation,  observation, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
      email: 'abbott@gri.msstate.edu',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, finding_entities, identification',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'land potential, soil science, crowdsourcing, open data, restoration, resilience, climate change',
      fields_of_science:
        'Animals, Climate and weather,  Computers and technology,  Ecology and environment,  Food,  Geography,  Geology and earth science,  Social science',
      project_status: 'active',
      agency_sponsor: 'U.S. Department of Agriculture',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, download_sw, geolocation, identification, learning, measurement,  observation, photography, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Education, Food,  Health and medicine',
      project_status: 'complete',
      agency_sponsor:
        'Department of Energy (DOE), Department of Housing and Urban Development, U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'National',
      participant_age: 'families, general_public',
      project_goals: '',
...

    {
      ...
      keywords:
        'photography, landscape, climate change, plant phenology, monitor, seasons',
      fields_of_science:
        'Archeology and cultural, Biology, Climate and weather,  Computers and technology,  Ecology and environment,  Education, Geography,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'National Aeronautics and Space Administration (NASA), National Science Foundation (NSF), National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'global',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, targeted_group, teens, Other',
      project_goals: '',
      participation_tasks:
        'annotation, diy_hacking_making, data_analysis, learning, measurement,  observation, photography, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Biology, Chemistry,  Computers and technology,  Health and medicine',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, finding_entities, learning,  observation, problem_solving',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'biogeochemistry, climate change, greenhouse gas exchange, migratory geese',
      fields_of_science: 'Ecology and environment',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'Astronomy, citizen science, zooniverse, Spitzer Space Telescope',
      fields_of_science: 'Astronomy and space',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, finding_entities, identification, measurement,  observation',
      scistarter: 'true',
      email: 'mspovich',
...

    {
      ...
      fields_of_science:
        'Biology, Ecology and environment,  Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Florida',
...

    {
      ...
      fields_of_science:
        'Geography,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'global',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, finding_entities, geolocation, identification,  observation, photography, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Computers and technology,  Ecology and environment,  Education, Geography,  Geology and earth science',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF),  National Aeronautics and Space Administration (NASA), Department of Energy (DOE)',
      agency_sponsor_other: '',
      geographic_scope: 'Worldwide',
      participant_age:
        'elementary_school_children, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'classification_tagging, diy_hacking_making, data_analysis, download_sw',
      scistarter: 'true',
...

    {
      ...
      keywords: 'zooniverse',
      fields_of_science:
        'Animals, Archeology and cultural, Astronomy and space, Biology, Birds, Chemistry,  Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Education, Health and medicine,  Nature and outdoors, Ocean/water and marine, Physics, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_analysis, identification, learning,  observation, transcription',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'laboratory astrophysics, radio astronomy, evolved stars, circumstellar chemistry, interstellar dust',
      fields_of_science: 'Astronomy and space, Chemistry,  Education, Physics',
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF), Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      geographic_scope: '',
      participant_age:
        'elementary_school_children, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, identification, learning, problem_solving',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'gravitational wave, astrophysics, astronomy, citizen science, machine learning',
      fields_of_science:
        'Astronomy and space, Computers and technology,  Physics',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      fields_of_science:
        'Biology, Computers and technology,  Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_analysis, data_entry, identification,  observation, photography, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_on_catalog: 'https://www.citizenscience.gov/catalog/370/',
      project_url_external: '',
      project_description:
      ...
      keywords: '',
      fields_of_science:
        'Computers and technology,  Ecology and environment,  Education, Ocean/water and marine, Psychology, Social science',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, identification, learning',
      scistarter: 'false',
      email: '',
...

    {
      ...
      fields_of_science:
        'Climate and weather,  Geology and earth science,  Physics',
      project_status: 'Complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      fields_of_science:
        'Biology, Climate and weather,  Computers and technology,  Health and medicine',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
...

    {
      ...
      fields_of_science:
        'Animals, Archeology and cultural, Biology, Birds, Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Education, Food,  Geography,  Geology and earth science,  Health and medicine,  Nature and outdoors, Ocean/water and marine, Pollinators/insects, Science policy, Social science, Transportation',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
      participant_age:
        'families, general_public, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, finding_entities, geolocation, identification, learning, measurement,  observation, photography, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_on_catalog: 'https://www.citizenscience.gov/catalog/376/',
      project_url_external: 'http://humain.acis.ufl.edu/',
      project_description:
      ...
      keywords:
        'Digitization, Crowdsourcing, Data extraction, Citizen science, Optical Character Recognition, Machine Learning, Scientific Data',
      fields_of_science: 'Computers and technology',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_entry, transcription',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF), U.S. Geological Survey (USGS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_analysis, download_sw, identification,  observation',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Wireless Channel, Signal Strength, Spectral Usage, Propagation',
      fields_of_science: 'Computers and technology',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      project_url_external:
        'https://www.nsf.gov/awardsearch/showAward?AWD_ID=1564386',
      project_description:
      ...
      keywords:
        'Dragonflies, damselflies, wing venation, computational-ecology, automatic-species-identification',
      fields_of_science:
        'Animals, Biology, Computers and technology,  Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, geolocation, identification, measurement,  observation, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'annotation, audio_video_recording, classification_tagging, data_analysis, download_sw',
      scistarter: 'false',
      email: '',
      start_date: '2016-08-01',
    },

    {
      ...
      keywords:
        'broadening participation, national parks, youth engagement, undergraduate biology education, pollinators',
      fields_of_science:
        'Ecology and environment,  Education, Nature and outdoors, Social science',
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF), National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Rocky Mountains',
      participant_age: 'Other',
      project_goals: '',
      participation_tasks:
        'audio_video_recording, classification_tagging, data_analysis, data_entry, learning, measurement,  observation, photography, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_entry, identification, learning',
      scistarter: 'false',
      email: '',
      start_date: '2014-09-01',
    },

    {
      ...
      fields_of_science:
        'Biology, Climate and weather,  Ecology and environment,  Nature and outdoors',
      project_status: 'hiatus',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'Landscaping, Green Infrastructure, Wildlife, Urban, Maps, Mapping, Nature',
      fields_of_science:
        'Birds, Climate and weather,  Ecology and environment,  Geography,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'North America',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, geolocation, identification, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'pollinators, environmental science, soil science, water quality, aquatic ecology, amphbian ecology',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, classification_tagging, data_analysis, data_entry, identification, measurement,  observation, photography, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Accessibility, urban informatics, ADA, mobility impairments, wheelchair access',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, finding_entities, identification',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Disaster response,  Education, Food,  Health and medicine,  Social science',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope:
        'Southeast Louisiana, principally Orleans and Chalmette Parishes',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'site_selection_description, specimen_sample_collection, transcription',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Natural History Collections, Transcription, Digitization, Museums, Herbaria, Universities, Education, Undergraduate, High School, birds, Flowers, Butterflies, #wedigbio',
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Nature and outdoors, Ocean/water and marine, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF), Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, data_entry, geolocation, identification, transcription',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Bats, Lesser long-nosed bats, Animal behavior, Coronado National Memorial, National Park Service',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope:
        'The videos are from Coronado National Memorial, but anyone can participate regardless of their location.',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks: 'classification_tagging,  observation',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'science of science and innovation policy, innovation dynamics, computational model',
      fields_of_science: 'Computers and technology,  Science policy',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Education, Geography,  Nature and outdoors, Ocean/water and marine, Pollinators/insects, Science policy',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, geolocation, identification, learning,  observation',
      scistarter: 'false',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Currently the greater Pittsburgh area, but hoping to expand in the coming years.',
      participant_age: 'middle_school_children',
      project_goals: '',
...

    {
      ...
      fields_of_science:
        'Animals, Archeology and cultural, Biology, Chemistry,  Climate and weather,  Computers and technology,  Ecology and environment,  Education, Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, download_sw, identification, learning, measurement,  observation, photography, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Education, Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'U.S. Forest Service (USFS), U.S. Department of Agriculture, National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'citizen science, management, open-space, natural resources, community, change',
      fields_of_science: 'Ecology and environment',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope:
        'Locally based but anywhere that can connect with project personnel via phone or internet or in person.',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, finding_entities, geolocation, identification, learning, measurement,  observation, photography, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection, Other',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Astronomy and space, Biology, Chemistry,  Climate and weather,  Computers and technology,  Ecology and environment,  Physics',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
...

    {
      ...
      keywords:
        'GIS, NSF, citizen science, drones, reefs, disaster, climate change, adaptation, UCF, Belize, Florida',
      fields_of_science:
        'Computers and technology,  Geography,  Nature and outdoors, Ocean/water and marine, Science policy, Social science',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, geolocation, learning,  observation',
      scistarter: 'true',
...

    {
      ...
      participant_age:
        'elementary_school_children, general_public, middle_school_children',
      project_goals: '',
      participation_tasks:
        'identification, measurement,  observation, specimen_sample_collection',
      scistarter: 'false',
      email: 'pdunn@uwm.edu',
...

    {
      ...
      keywords:
        'radio transmitter, hummingbird feeder, bat, agave, saguaro, roost',
      fields_of_science:
        'Animals, Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'U.S. Fish and Wildlife Service',
      ...
      project_goals: '',
      participation_tasks:
        'identification, measurement,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://sites.google.com/site/researchandexpedition/',
      project_description:
      ...
      keywords:
        'Battle of the Atlantic, World War One, World War Two, Diving, Underwater Archaeology',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, identification, measurement,  observation, photography',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'monitoring, shoreline, beached birds, seabirds, marine mammals, human activities',
      fields_of_science: 'Biology',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope:
        'shoreline from Point Arena south to Ano Nuevo, CA (does not include San Francisco Bay shoreline',
      participant_age: 'Other',
      project_goals: '',
      participation_tasks:
        'data_entry, measurement,  observation, photography, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Archeology and cultural, Biology, Climate and weather,  Ecology and environment,  Education, Food,  Social science',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Rocky intertidal & Nearshore Areas throughout the Hawaiian archipelago',
      participant_age:
        'families, general_public, middle_school_children, targeted_group, teens, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, learning, measurement,  observation, photography, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, photography',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'water quality, macroinvertebrates, open educational resources, observation, identification, taxonomy, design',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification,  observation, photography',
      scistarter: 'true',
      email: 'martil@cmu.edu',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, identification, learning,  observation, problem_solving',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Mapping algorithms, crowdsourcing, custom domain specific architectures, reconfigurable architectures',
      fields_of_science: 'Computers and technology',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: '',
      participant_age:
        'general_public, middle_school_children, targeted_group, teens, Other',
      project_goals: '',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Health and medicine,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'North America',
      ...
      project_goals: '',
      participation_tasks:
        'measurement,  observation, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'finding_entities, geolocation, measurement,  observation',
      scistarter: 'false',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'U.S Affiliated Pacific Islands - Freely Associated States',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'diy_hacking_making, measurement,  observation, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Ladybugs, endangered species, invasive species, biological control, conservation, photography',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, finding_entities, learning,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'learning, measurement,  observation, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'pervasive, computing, disaster, response, sensors, fires, floods, earthquakes, radiation, seismic, networks, detection',
      fields_of_science: 'Disaster response',
      project_status: 'complete',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, geolocation, identification, learning, measurement,  observation',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'mammal, deer, coyote, cameratrap, game camera, trail camera, bear, turkey, squirrel',
      fields_of_science:
        'Animals, Biology, Computers and technology,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor:
        'National Science Foundation (NSF), Smithsonian Institution (SI)',
      agency_sponsor_other:
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, finding_entities, geolocation, identification, photography, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'National Oceanic and Atmospheric Administration (NOAA), National Archives and Records Administration (NARA)',
      agency_sponsor_other:
        'NOAA and National Archives and Records Administration',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Great Basin National Park, Baker, NV and surrounding valley areas',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'annotation, classification_tagging, finding_entities, identification, learning,  observation',
      scistarter: 'false',
      email: 'gretchen_baker@nps.gov',
      start_date: '2016-05-20',
    },

    {
      ...
      project_url_external:
        'http://eowilsonfoundation.org/atbibioblitz-swat-team/ ',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, classification_tagging, data_entry, identification, learning, photography, problem_solving, sample_analysis, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'raptors, migration, phenology, hawks, falcons, eagles, birds, ggnra, national parks',
      fields_of_science:
        'Biology, Birds, Climate and weather,  Ecology and environment',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, identification, learning, measurement,  observation, specimen_sample_collection, Other',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Monitoring, recording, observations, following science protocols, phenology',
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Education, Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Craters of the Moon National Monument',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, geolocation, identification, learning, measurement,  observation, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Geology and earth science',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, identification, learning, measurement,  observation',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'http://www.inaturalist.org/projects/joshua-tree-national-park-wildflower-watch',
      project_description:
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope:
        'Appalachian Trail and adjacent areas, from Maine to Georgia.',
      participant_age:
        'families, general_public, middle_school_children, targeted_group, teens',
      project_goals: '',
      participation_tasks:
        'annotation, data_entry, geolocation, identification, learning,  observation',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Ecology and environment,  Education, Nature and outdoors, Ocean/water and marine',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_entry, geolocation, identification, measurement, observation, photography, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/articles/urban-archeology-corps.htm',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, learning,  observation, problem_solving, Other',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Every Kid in a Park, biodiversity, botany, ecology, Ashland, Oregon, hiking, science, data collection, bioblitz, students, environmental education',
      fields_of_science:
        'Biology, Ecology and environment,  Geography,  Geology and earth science,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor:
        'National Park Service (NPS), Bureau of Land Management (BLM), U.S. Forest Service (USFS)',
      agency_sponsor_other: '',
      geographic_scope: '',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, learning,  observation, photography',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/teachers/classrooms/life-in-the-extreme.htm',
      project_description:
      ...
      keywords:
        'Experiencing, investigating and pondering, measuring environmental parameters drawing conclusions, testing hypotheses, survival, interconnected, physical environment',
      fields_of_science:
        'Animals, Biology, Climate and weather,  Computers and technology,  Ecology and environment,  Education, Geology and earth science,  Nature and outdoors, Science policy',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Craters of the Moon National Monument',
      participant_age:
        'elementary_school_children, families, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'annotation, diy_hacking_making, data_analysis, geolocation, identification, learning, measurement,  observation, site_selection_description, transcription',
      scistarter: 'false',
      email: 'matthew_d_daniel@nps.gov',
      start_date: '',
    },

    {
      ...
      project_url_external:
        'http://www.kidsinparks.com/carl-sandburg-home-national-historic-site',
      project_description:
      ...
      keywords:
        'Citizen Science, National Park, Carl Sandburg, Climate, Ecosystem, Track Trail, Kids, Families',
      fields_of_science:
        'Animals, Climate and weather,  Ecology and environment,  Education, Geography,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'annotation, data_analysis, data_entry, identification, learning, measurement,  observation, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.facebook.com/Mojave-National-Preserve-151022481577447/',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, learning, measurement,  observation, photography, problem_solving',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Education, Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, identification, learning, measurement, photography, problem_solving',
      scistarter: 'true',
      email: 'David_R_Nichols@nps.gov',
...

    {
      ...
      project_status: 'active',
      agency_sponsor:
        'National Park Service (NPS), U.S. Fish and Wildlife Service',
      agency_sponsor_other:
        'U.S. Fish and Wildlife Service Hopper Mountain National Wildlife Refuge Complex, Pinnacles National Park',
...

    {
      ...
      project_url_external:
        'https://www.inaturalist.org/projects/petrified-forest-national-park-natural-history-observations',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Northeastern Arizona, specifically within the Petrified Forest National Park',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_entry, geolocation, identification, learning,  observation, photography',
      scistarter: 'true',
      email: 'andrew_bridges@nps.gov',
...

    {
      ...
      project_url_external:
        'http://www.inaturalist.org/observations?verifiable=any&project_id=6810&place_id=95234',
      project_description:
        'iNaturalist public project started in 2016 to identify species and locations within the park',
      keywords: '',
      fields_of_science:
        'Animals, Biology, Birds, Geology and earth science,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, download_sw, geolocation, identification, learning,  observation, photography',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://picturepost.unh.edu/post.jsp?postId=1190#picset=17044&orientation',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Climate and weather,  Ecology and environment,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Park-based',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'https://picturepost.unh.edu/post.jsp?postId=1178#picset=17421&orientation',
      project_description:
        'The result of a National Park Service-George Mason University Climate Change Communication Internship, the two wayside exhibits in the Wolf Trap National Park for the Performing Arts link native plants and pollinators with climate. The Wolf Trap wayside project sought to draw connections between the importance of preserving natural landscapes and how the park is being impacted by climate change. The aim was to develop a wayside that supported the park’s broader goals to develop an outdoor classroom by highlighting the native plant garden and meadow. In working with the park staff, the interns developed a narrative that used pollinators as the main character. The narrative calls attention to the importance of native plants and pollinators in creating healthy ecosystems and how citizen science at the park was creating habitat. A key component of this story was communicating how climate change is currently impacting the plant-pollinator relationship through shifting bloom times. ...This wayside explains how climate is impacting pollination and the relationship between plants, pollinators, and people. This narrative encourages volunteerism and citizen science at Wolf Trap through phenological monitoring programs ranging from species counts and a picture post. In addition to the wayside content, the interactive material includes a citizen scientist video, native bee facts, and a family activity encouraging the exploration of the garden through a plant identification game.  http://esp.gmu.edu/wp-content/uploads/2013/12/ESP_Newsletter_Fall_2013.pdf',
      keywords: 'Pollinators Native Plants',
      fields_of_science:
...

    {
      ...
      keywords:
        'camas, camas lily, citizen science, Weippe Prairie, wet meadow',
      fields_of_science:
        'Biology, Climate and weather,  Ecology and environment,  Food,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other:
        'Upper Columbia Basin Network Inventory & Monitoring Network',
      geographic_scope:
        'Seasonal wet prairie ecosystem of the interior Columbia Plateau',
      participant_age: 'teens',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'https://picturepost.unh.edu/post.jsp?postId=1194#picset=19115&orientation',
      project_description:
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/rlc/craterlake/upload/MHPP-student-hypothesis-guide.pdf',
      project_description:
      ...
      fields_of_science:
        'Biology, Climate and weather,  Computers and technology,  Ecology and environment,  Education, Geology and earth science,  Nature and outdoors',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, identification, learning, measurement,  observation',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/grte/learn/education/for-teachers.htm',
      project_description:
      ...
      keywords:
        'Citizen Science, Species Monitoring, Invasive Fish Species, Kelly Warm Spring, Grand Teton National Park, Management',
...

    {
      ...
      project_url_external:
        'http://joshuamrapp.com/2015/10/acernet-funded-by-ne-csc/',
      project_description:
      ...
      project_status: 'active',
      agency_sponsor:
        'National Park Service (NPS), U.S. Department of the Interior (DOI)',
      agency_sponsor_other: '',
      geographic_scope: 'Indiana Dunes National Lakeshore',
      participant_age: 'general_public',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'https://picturepost.unh.edu/post.jsp?postId=1177#picset=18215&orientation',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Park-based',
      participant_age:
        'elementary_school_children, families, general_public, teens',
      project_goals: '',
      participation_tasks: 'photography',
      scistarter: 'false',
      email: 'ann_gallagher@nps.gov',
...

    {
      ...
      fields_of_science:
        'Education, Geology and earth science,  Nature and outdoors, Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'North America',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, learning, measurement,  observation, site_selection_description',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Biodiversity, BioBlitz, Community, Trees, Medicinal Herbs, Mammals, Invasive Species, Nature, Training, Capacity Building, Participatory Governance',
      fields_of_science:
        'Animals, Biology, Ecology and environment,  Education, Nature and outdoors, Science policy',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'geolocation, identification, learning,  observation, photography, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'New England, Salt marsh, environmental stewardship, summer camp, ages 9-12, ecosystems',
      fields_of_science:
        'Biology, Ecology and environment,  Geology and earth science,  Ocean/water and marine',
      project_status: 'complete',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, measurement,  observation, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Chesapeake Bay, Watershed, Water quality monitoring, benthic macroinvertebrates, DO, pH, Nutrients, Sediment, Stream health',
      fields_of_science:
        'Biology, Chemistry,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      ...
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, learning, measurement,  observation, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'lake, missouri, water, quality, reservoir, Secchi, chlorophyll, phosphorus, nitrogen',
      fields_of_science:
        'Biology, Chemistry,  Ecology and environment,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, measurement,  observation, site_selection_description, specimen_sample_collection',
      scistarter: 'true',
      email: 'tony@LMVP.org',
...

    {
      ...
      keywords:
        'Deaf; Deaf Community Research; informed consent; simulation; community engagement',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, problem_solving, transcription',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'ocean, king tide, flooding, water level, flood, story map, crowd source, storm, sea-level rise, storm surge',
      fields_of_science:
        'Climate and weather,  Disaster response,  Ocean/water and marine',
      project_status: 'complete',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
...

    {
      ...
      fields_of_science:
        'Biology, Climate and weather,  Computers and technology,  Disaster response,  Ecology and environment,  Geology and earth science,  Nature and outdoors, Pollinators/insects',
      project_status: 'active',
      agency_sponsor: 'U.S. Forest Service (USFS)',
      agency_sponsor_other: '',
      geographic_scope:
        'regional - Rim Fire footprint, Tuolumne Wild & Scenic River watershed, Groveland Ranger District, Stanislaus National Forest',
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens',
      project_goals: '',
...

    {
      ...
      project_url_external:
        'http://docs.wixstatic.com/ugd/de16c8_447bb34214f143b99b65e9b924e617b8.pdf',
      project_description:
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, identification, learning, measurement,  observation, photography, sample_analysis',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.greeningofdetroit.com/citizen-foresters/',
      project_description:
...

    {
      ...
      project_url_external:
        'http://www.inaturalist.org/projects/kaibab-nf-2017-citizen-science-project',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Birds, Ecology and environment,  Geography,  Nature and outdoors, Pollinators/insects, Social science',
      project_status: 'active',
      agency_sponsor: 'U.S. Forest Service (USFS)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, classification_tagging, data_entry, geolocation, identification, learning, measurement,  observation, photography, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, measurement,  observation, site_selection_description',
      scistarter: 'false',
      email: '',
      start_date: '2016-08-01',
    },

    {
      ...
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, targeted_group',
      project_goals: '',
      participation_tasks:
        'data_entry, geolocation, learning, measurement,  observation, photography, sample_analysis, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'Citizen science, air quality, air pollution, exposure reduction, health, environmental health, environmental literacy',
      fields_of_science:
        'education, Health and medicine,  Nature and outdoors, Social science',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'learning, measurement,  observation, problem_solving, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'environmental health, environmental pollution, hazardous waste, soil, water, vegetables, underserved communities, environmenta justice',
      fields_of_science: 'Chemistry,  Education, Food',
      project_status: 'active',
      agency_sponsor:
        'U.S. Environmental Protection Agency (EPA), National Institutes of Health (NIH)',
      agency_sponsor_other: '',
      geographic_scope: 'All US, specifically AZ',
      participant_age: 'general_public',
      project_goals: '',
      participation_tasks:
        'learning, measurement,  observation, photography, sample_analysis, site_selection_description',
      scistarter: 'false',
      email: 'mdramire@email.arizona.edu',
...

    {
      ...
      keywords:
        'smoke, smokesense, wildfire, wildland fire, particulate matter, ozone, health, productivity',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_entry, photography, specimen_sample_collection',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'adult education, air, capacity building, environmental justice, exposure, health effects, Midwest, monitoring, surveys, transformative learning',
      fields_of_science:
        'Ecology and environment,  Education, Science policy, Transportation',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'audio_video_recording, data_analysis, data_entry, finding_entities, learning, measurement,  observation, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'Environment, Central California, Cal-EPA courses, Cal-EPA flowchart',
      fields_of_science: 'Ecology and environment',
      project_status: 'active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      ...
      project_goals: '',
      participation_tasks:
        'learning,  observation, problem_solving, site_selection_description',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'garden, harvested rainwater, soil, environmental monitoring, rural, urban, plants, vegetables,',
      fields_of_science:
        'Chemistry,  Climate and weather,  Education, Food,  Geology and earth science',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: '',
...

    {
      ...
      keywords:
        'SMART, INCLUDES, stormwater, water pollution, water quality, students, high school, broadening participation, diverse, female, minority, STEM, engineering, environmental science, mentor, mentorship, community',
      fields_of_science:
        'Biology, Chemistry,  Computers and technology,  Ecology and environment,  Education, Nature and outdoors, Physics',
      project_status: 'active',
      agency_sponsor: 'National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope:
        'Maine, New York, North Carolina, Florida, Alabama, Mississippi, Missouri, California',
      participant_age: 'teens, Other',
      project_goals: '',
      participation_tasks:
        'classification_tagging, data_analysis, data_entry, identification, learning, measurement,  observation, problem_solving, sample_analysis, site_selection_description, specimen_sample_collection, Other',
      scistarter: 'true',
...

    {
      ...
      project_goals: '',
      participation_tasks:
        'data_analysis, data_entry, measurement,  observation, sample_analysis, site_selection_description, specimen_sample_collection',
      scistarter: 'false',
...

    {
      ...
      keywords:
        'air pollution, point source, volcano, volcanic smog, sensor networks, science curriculum; sulfur dioxide',
...

    {
      ...
      project_url_external:
        'https://cfpub.epa.gov/ncer_abstracts/index.cfm/fuseaction/display.abstractDetail/abstract/10743/report/0',
      project_description:
...

    {
      ...
      participant_age:
        'elementary_school_children, families, general_public, middle_school_children, teens, Other',
      project_goals: '',
      participation_tasks: 'classification_tagging,  observation',
      scistarter: 'true',
...

    {
      ...
      keywords:
        'landslide, landslides, NASA, GIS, VGI, natural disasters, natural hazards',
      fields_of_science:
        'Disaster response,  Ecology and environment,  Geography,  Geology and earth science,  Nature and outdoors',
      project_status: 'active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'southwest Washington, Portland Oregon metropolitan area',
      participant_age: 'General public, Targeted group',
      project_goals:
        'The project’s goals were to archaeologically test portions of the Vancouver Barracks to assess the scientific and historical values of the resources and to gather data on areas that may be affected by utilities upgrades and related construction activities tied to building rehabilitation, landscaping and parking.',
      participation_tasks:
        'Classification or Tagging, Data Analysis, Data Entry, Identification, Measurement, Observation, Photography, Problem Solving, Sample Analysis, Specimen/Sample Collection',
      scistarter: 'false',
      email: 'doug_wilson@nps.gov',
      start_date: '6/1/2017',
    },

    {
      ...
      project_url_external:
        'https://www.westcoast.fisheries.noaa.gov/protected_species/rockfish/rockfish_in_puget_sound.html',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Ecology and environment, Education, Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'active',
      agency_sponsor:
      ...
      participation_tasks:
        'Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.fisheries.noaa.gov/feature-story/hawaii-bottomfish-heritage-project',
      project_description:
      ...
      keywords: '',
      fields_of_science:
        'Archaeology and cultural, Ecology and environment, Food, Ocean/water and marine, Social science',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Hawaii',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather, Ecology and environment, Education, Nature and outdoors, Ocean/water and marine, Pollinators/insects',
      project_status: 'Active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Acadia National Park and Downeast Maine',
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'The project aims to document biodiversity and phenology to improve understanding of natural resources, inform management decisions, and provide educational and inspirational experiences for park visitors and local communities.',
      participation_tasks:
        'Classification or Tagging, Data Entry, Identification, Learning, Observation, Photography',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://cfpub.epa.gov/si/si_public_record_report.cfm?dirEntryId=340734',
      project_description:
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/air-research/citizen-science-air-monitoring-puerto-rico-fact-sheet',
      project_description:
      ...
      keywords:
        'sensor performance; environmental awareness; emerging sensor technologies',
      ...
      project_goals:
        'A research partnership with a Puerto Rico-based regional consortium, Desarrollo Integral del Sur, Inc. (DISUR), was developed to determine the challenges and benefits of low-cost AQ sensors for citizen science. EPA developed a unique low-cost multi-pollutant sensor pod that was provided to the community group and the training/tools needed for its operation. The citizens self-organized a community effort to conduct approximately 5 months of intensive AQ monitoring in residential areas of Guayanilla and Peñuelas, Puerto Rico having little historical data on spatial variability. The citizens successfully completed the intensive data collections, summarization of quality assurance checks, and database development. The study provided environmental justice communities in Peñuelas and Guayanilla, as well as surrounding communities, an awareness of local air quality conditions and opportunities for citizen scientists to gain extensive experience in use of emerging sensor technologies. The collaboration provided EPA an opportunity to evaluate low-cost sensor performance under harsh environmental conditions (high relative humidity in a coastal environment).',
      participation_tasks:
        'Data Analysis, Data Entry, Learning, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: 'false',
      email: 'Williams.ronald@epa.gov',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/air-research/instruction-guide-and-macro-analysis-tool-community-led-air-monitoring',
      project_description:
...

    {
      ...
      project_url_external:
        'https://cfpub.epa.gov/si/si_public_record_report.cfm?dirEntryId=335482&Lab=NERL',
      project_description:
      ...
      participation_tasks:
        'Data Analysis, Sample Analysis, Specimen/Sample Collection',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Animals, Ecology and environment, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope:
        'National participation, video & photographs from Great Lakes',
      participant_age: 'General public',
      project_goals:
      ...
      participation_tasks:
        'Classification or Tagging, Identification, Observation',
      scistarter: 'false',
...

    {
      ...
      geographic_scope: 'National',
      participant_age:
        'General public, Middle school (11-13), Targeted group, Youth/teen (up to 17)',
      project_goals:
        'Cyanoscope provides opportunity to identify taxa within a waterbody of interest, learn about that taxa, submit images, and locational information to a centralized database, and view geographical distributions of various taxa.',
      participation_tasks:
        'Classification or Tagging, Data Entry, Identification, Observation, Photography, Sample Analysis, Specimen/Sample Collection',
      scistarter: 'true',
      email: 'snook.hilary@epa.gov',
      start_date: '1/1/2013',
    },

    {
      ...
      project_url_external:
        'https://www.youtube.com/watch?v=w57F_nSV0a4&list=PLMSa5d-iIl6OsjuwK3Fh0tH6D4BOmFneV',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'California- in Riverside County, Los Angeles County, Clear Lake Watershed',
      participant_age: 'Targeted group',
      project_goals:
      ...
      participation_tasks:
        'Data Entry, Geolocation, Identification, Measurement, Observation, Photography, Site Selection and/or Description',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/sites/production/files/2018-03/documents/final_em-3_master_slide_set.pdf',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Check your local Regional EPA office – loans currently scheduled for EPA Regions 1, 2, 3, 5, and 8',
...

    {
      ...
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other:
        'U.S. Department of Agriculture, National Institutes of Health (NIH)',
      geographic_scope: 'National',
      participant_age: 'Targeted group',
      project_goals:
        'HiveScience is a citizen science project, designed for beekeepers, that promotes EPA-public engagement around collecting data on hive health -- an important research issue at the local, national and international levels.  For this project, beekeepers collect data on the health status of honey bee hives, submit a sample of honey for laboratory analysis for biomarkers of honey bee immune response, and provide data on the overwintering fate of sampled hives using an EPA-branded mobile application.  Ultimately, these data will be used to determine if there is a correlation between biomarkers of honey bee colony health and actual colony overwintering performance.',
...

    {
      ...
      project_url_external:
        'https://www.inaturalist.org/projects/city-nature-challenge-2018-washington-dc-metro-area',
      project_description:
      ...
      project_goals:
        'The Smithsonian’s goal was to increase participation, raise awareness, and become more competitive as a city. Washington, DC placed fourth overall in number of participants, fifth in observations, and eighth in species.',
      participation_tasks:
        'Audio or Video Recording, Geolocation, Identification, Observation, Photography',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Climate and weather, Ecology and environment, Geography, Geology and earth science, Nature and outdoors',
      project_status: 'Active',
      agency_sponsor: 'Department of Energy (DOE)',
      agency_sponsor_other: '',
      geographic_scope:
        'We are specifically targeting two locations- northeastern Oklahoma and western Pennsylvania. However, we are interested in data from any part of the continental United States.',
      participant_age: 'Families, General public, Youth/teen (up to 17)',
      project_goals:
        'Our project will collect locations of orphaned wells, compare those locations to state databases, and inform proper authorities of the locations of the wells while also assessing environmental hazards such as methane emissions.',
      participation_tasks:
        'Data Entry, Geolocation, Observation, Photography, Site Selection and/or Description',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Animals, Biology, Climate and weather, Ecology and environment, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'Smithsonian Institution (SI)',
      agency_sponsor_other: '',
      geographic_scope: 'Worldwide',
      participant_age: 'General public',
      project_goals:
        'Understand how invasive species impact marine fouling communities',
...

    {
      ...
      fields_of_science:
        'Climate and weather, Education, Health and medicine, Nature and outdoors, Science policy, Social science',
      project_status: 'active_but_seasonal',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope: 'Up to 5 U.S. cities in 2019, to be determined',
      participant_age:
        'Families, General public, Targeted group, Youth/teen (up to 17)',
      project_goals:
        'On some of the hottest days of summer, NOAA-sponsored teams of scientists and citizen scientists conduct field campaigns to measure and map the urban heat islands of up to five selected cities.',
      participation_tasks: 'Measurement, Observation',
      scistarter: 'false',
...

    {
      ...
      project_url_external:
        'https://www.nefsc.noaa.gov/rcb/projects/gopro-aquaculture/',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Long Island Sound and other estuaries in which shellfish aquaculture occurs',
      participant_age: 'General public, Targeted group, Shellfish growers',
      project_goals:
        'The goal of this project is to document how oyster cages used in shellfish aquaculture provide habitat, and determine whether that habitat is similar or different from habitat provided by naturally occurring rock reef environments.',
...

    {
      ...
      fields_of_science:
        'Biology, Climate and weather, Ecology and environment, Ocean/water and marine',
      project_status: 'pending',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope: 'Central South Carolina',
      participant_age:
        'Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'The goal of this project is to collect regular data on bacterial concentrations in park waters in order to identify contamination concerns and track concentration trends.',
      participation_tasks:
        'Data Entry, Sample Analysis, Specimen/Sample Collection',
      scistarter: 'false',
...

    {
      ...
      fields_of_science:
        'Animals, Biology, Birds, Chemistry, Ecology and environment, Education, Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'Conduct 10 minute surveys collecting nurdles to map concentrations of pollution.',
      participation_tasks:
        'Data Entry, Identification, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.plymouth-ma.gov/marine-and-environmental-affairs/pages/town-brook-herring-information',
      project_description:
      ...
      fields_of_science:
        'Animals, Computers and technology, Ecology and environment, Education, Nature and outdoors',
...

    {
      ...
      participant_age:
        'General public, Middle school (11-13), Targeted group, Youth/teen (up to 17)',
      project_goals:
        'Data collected with your help will provide a novel picture of the fishery prior to dedicated monitoring programs and help improve our understanding of the fishery for several iconic species.',
      participation_tasks: 'Classification or Tagging, Identification',
      scistarter: 'true',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Biology, Computers and Technology, Health and Medicine, Social Science',
      project_status: 'Active',
      agency_sponsor: 'National Institutes of Health (NIH)',
      agency_sponsor_other: '',
      geographic_scope: 'Nationwide',
      participant_age: '',
      project_goals:
        'By holding #CiteNLM Edit-a-thons, we can 1)Make it easier to get credible, evidence-based health information online; 2)Disseminate NLM sources and increase their reach; 3)Leverage network members’ expertise, experiences, and audiences; and 4)Engage NNLM members nationwide.',
...

    {
      ...
      project_url_external:
        'https://www.nps.gov/long/getinvolved/volunteer.htm',
      project_description:
      ...
      participant_age: '',
      project_goals:
        "We are aiming to increase access to the park's collections, fostering a sense of stewardship toward historic artifacts.",
      participation_tasks: 'Transcription',
      scistarter: '',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Biology, Computers and technology, Education, Health and medicine',
      project_status: 'Active',
      agency_sponsor: 'U.S. Department of Health and Human Services (HHS)',
      agency_sponsor_other: '',
      geographic_scope:
        'Chapel Hill, NC; Santa Cruz, CA; Boston, MA; Bethesda, MD; Houston, TX; College Park, MD; Dallas, TX; Pittsburgh, PA; New York City, NY',
      participant_age: '',
      project_goals:
        'Codeathons aim to build bridges across communities to create novel crowd sourced solutions while offering creative training opportunities.',
      participation_tasks:
        'annotation, classification or tagging, DIY hacking/making, data analysis, download software for distributed computer projects, identification, learning, problem solving, sample analysis',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://www.zooniverse.org/projects/benjamin-dot-richards/oceaneyes',
      project_description:
      ...
      keywords:
        'fish, fisheries, cameras, video, snapper, grouper, machine learning, computer vision, artificial intelligence',
      fields_of_science: 'Biology',
      project_status: 'active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      participant_age: '',
      project_goals:
        'OceanEYEs has three objectives, 1) to increase education and outreach, 2) to create high quality and high volume training data for machine learning algorithms, and 3) to allow scientists to evaluate alternative methods for enumeration of fish targets from video.',
...

    {
      ...
      fields_of_science:
        'Biology, Chemistry, Computers and technology, Health and medicine, Physics',
      project_status: 'complete',
      agency_sponsor: 'National Institutes of Health (NIH)',
      ...
      participant_age: '',
      project_goals:
        'Develop innovative research projectsto advance the development of a model of an individual cancer patient and lead to disease and intervention-specific models and simulations.',
      participation_tasks:
        'classification and tagging, data anylsis, download software for distributed computer projects, learning, measurement, observation, problem solving',
      scistarter: '',
...

    {
      ...
      keywords:
        'Northeast Cooperative Research Branch, NEFSC Ocean and Climate Branch, larval transport',
      fields_of_science:
        'Climate and weather, Computers and technology, Ecology and environment, Education, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Data collected from thousands of locations on the Northeast Continental Shelf by commercial fishing vessels emanating from dozens of ports ranging from New Jersey to Nova Scotia',
      participant_age: '',
      project_goals:
        'With help from the commercial fishing industry, the Gulf of Maine Lobster Foundation in particular, we hope to collect basic physical oceanographic data that can a) improve both ocean circulation models and stock assessments and b) contribute to our local ocean observing system for decades to come.',
      participation_tasks:
        'download software for distributed computer projects, learning, measurement, observation, problem solving',
      scistarter: '',
...

    {
      ...
      agency_sponsor_other: 'National Marine Fisheries Service',
      geographic_scope:
        'Tag recoveries by fishermen occur and are reported from all federal fishery locations in Alaska, as well as internationally (Japan, Russia, Canada and Mexico).',
      participant_age: '',
      project_goals:
        'We are improving and streamlining the process for industry to report data by developing a tag recovery reporting application (app) for mobile devices. A mobile app would simplify the process for fishermen when returning recovered tags and presumably could improve reporting rates and provide more tag data.',
      participation_tasks:
        'classification and tagging, data entry, geolocation, identification, measurement, observation, site selection and/or description, sepecimen/sample collection',
      scistarter: '',
...

    {
      ...
      project_url_on_catalog: 'https://www.citizenscience.gov/catalog/515/',
      project_url_external:
        'https://www.usgs.gov/center-news/flowper-user-s-guide-collection-flow-permanence-field-observations',
      project_description:
      ...
      fields_of_science:
        'Ecology and environment, Geography, Geology and earth science, Nature and outdoors',
      project_status: 'Active',
      agency_sponsor: 'U.S. Department of the Interior (DOI)',
      agency_sponsor_other:
        'U.S. Forest Service (USFS); Bureau of Land Management (BLM)',
      geographic_scope:
        'Forested streams throughout Oregon, western Washington, and Idaho, but can occur anywhere',
      participant_age: '',
      project_goals:
        'Substantially increase frequency and geographical extent of data collection of streamflow conditions in what has been historically data sparse regions of the river network',
      participation_tasks:
        'data entry, geolocation, measurement, observation, photography, site selection and/or description',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Biology, Climate and weather, Computers and technology, Ecology and environment, Education, Geography, Geology and earth science, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      ...
      participant_age: '',
      project_goals:
        'Provide visitors a deeper understainding of the dynamic effect humans, nature and restoration work have on habitats at Indiana Dunes, and how they can help protect park resources.',
      participation_tasks:
        'data entry, finding entities, geolocation, learning, observation, photography',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Animals, Birds, Nature and outdoors, Pollinators/insects',
      project_status: 'Active',
      agency_sponsor: 'National Park Service (NPS)',
      agency_sponsor_other: '',
      geographic_scope:
      ...
      participant_age: '',
      project_goals:
        'This project, overseen by Discover Life in America, aims to benefit from the observational skills of park visitors to help develop distribution probability maps for species found in Great Smoky Mountains National Park.',
      participation_tasks:
        'Annotation, Audio or Video Recording, Identification, Observation, Photography',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Animals, Archaeology and cultural, Biology, Climate and weather, Computers and technology, Disaster response, Ecology and environment, Education, Food, Geography, Geology and earth science, Health and medicine, Nature and outdoors, Ocean/water and marine, Science policy, Social science',
      project_status: 'Active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Global - with focus on past and future field campaigns to Guam, Puerto Rico, Samoa, Marshall Islands, Red Sea, among other locations.',
      participant_age: '',
      project_goals:
        "Map Earth's Oceans in this videogame that trains an AI for the NASA supercomputer using FluidCam's 3D images of the seafloor, the first instrument that can see through waves",
      participation_tasks:
        'Annotation, Classification and Tagging, Data Analysis, Data Entry, Geolocation, Identification, Learning, Measurement, Observation, Problem Solving, Sample Analysis',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://eol.jsc.nasa.gov/BeyondThePhotography/FeatureHunter/',
      project_description:
      ...
      fields_of_science:
        'Ecology and environment, Geography, Geology and earth science',
      project_status: 'Active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Whole Earth (astronauts collect imagery of all continents but Antarctica)',
      participant_age: '',
      project_goals:
        'Feature Hunter is aiming to improve the astronaut photography database by utilizing machine learning to identify of features within images with the help of training data generated by citizen scientists.',
...

    {
      ...
      keywords: '',
      fields_of_science:
        'Climate and weather, Computers and technology, Disaster response, Education, Nature and outdoors, Science Policy, Social Science, Transportation',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope:
        'Any location on the globe - there is no fixed location of activity.',
      participant_age: '',
      project_goals:
        'To determine how well precpipitation type algorithms perform and whether new algorithms are an improvement.',
      participation_tasks:
        'Classification or Tagging, Data Analysis, Data Entry, Geolocation, Observation, Problem Solving',
      scistarter: '',
...

    {
      ...
      project_url_on_catalog: 'https://www.citizenscience.gov/catalog/522/',
      project_url_external: 'https://www.mlml.calstate.edu/ccfrp/',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'California state waters within 15 designated marine protected areas, and 16 reference sites adjacent to those areas',
      participant_age: '',
      project_goals:
        'The California Collaborative Fisheries Research Project (CCFRP) was designed to monitor California’s network of marine protected areas (MPAs) in order to evaluate their effectiveness as a tool for conservation and fisheries management.',
      participation_tasks: 'Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://github.com/NASA-Tournament-Lab/CDC-NLP-Occ-Injury-Coding',
      project_description:
      ...
      agency_sponsor: 'Center for Disease Control',
      agency_sponsor_other:
        'National Aeronautics and Space Administration (NASA); Bureau of Labor and Statistics',
      geographic_scope: 'remotely, world-wide',
      participant_age: '',
      project_goals:
        'Automatically classify free-text injury narratives into standardized coding systems using state-of-the-art machine learning, natural language processing algorithms to ease the burden on manual coders.',
      participation_tasks:
        'Classification or Tagging, Data Analysis, Problem Solving',
      scistarter: '',
      email: 'inh4@cdc.gov',
...

    {
      ...
      project_url_external:
        'https://www.usgs.gov/centers/sbsc/science/citizen-science-light-trapping-grand-canyon',
      project_description:
      ...
      participant_age: '',
      project_goals:
        'Monitor health of the Colorado River ecosystem in Grand Canyon and identify cost-effective environmental flow strategies at Glen Canyon Dam that can improve ecosystem health.',
      participation_tasks: 'Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Climate and weather, Ecology and environment, Geology and earth science',
      project_status: 'In Planning or Pending',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope:
        'This project is still in the planning stage. Expected partners include Catawba Indian Nation Tribal Land, Rock Hill, SC; Broward County, FL; Orlando, FL; Raleigh, NC; Jacksonville, FL; Louisville, KY; Cherokee Nation, OK; and multiple other locations to be determined.',
      participant_age: '',
      project_goals:
        'This project aims to increase the availability of locations for the public to compare their own lower-cost air quality sensor measurements with established, more expensive EPA methods for air quality measurement.',
...

    {
      ...
      project_url_external:
        'https://coastalscience.noaa.gov/research/stressor-impacts-mitigation/hab-monitoring-system/hab-forecasts/',
      project_description:
      ...
      fields_of_science:
        'Biology, Computers and technology, Ecology and environment, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      participant_age: '',
      project_goals:
        "The 'red tide' blooms can be quite patchy, so the HABscope project has the goal of moving us from the current weekly sampling for Karenia brevis at selected beaches to 'every beach, every day.'",
      participation_tasks:
        'Audio or Video Recording, Data Entry, Identification, Observation, Photography',
      scistarter: '',
      email: 'hab@noaa.gov',
...

    {
      ...
      geographic_scope:
        'There were participants form Spain, Italy, Germany, Austria, South Korea, Brazil, and the US states of Kansas, Wisconsin, Missouri, Texas, California, Minnesota, Illinois, Idaho, South Carolina, Florida, and Alabama.',
      participant_age: '',
      project_goals:
        'This project is exmaning the impact of different soil mineralogies and climates on alterations in biochar agrochemical sorption and greenhouse gas mitigation potentials.',
      participation_tasks: 'Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      keywords:
        'collaborative adaptive rangeland management, participatory science, management-science partnerships',
      fields_of_science:
        'Animals, Archaeology and cultural, Biology, Birds, Chemistry, Climate and weather, Computers and technology, Ecology and environment, Education, Food, Geography, Nature and outdoors, Social Science',
      project_status: 'Active',
      agency_sponsor: 'U.S. Department of Agriculture',
      agency_sponsor_other:
        'Agricultural Research Service, U.S. Forest Service (USFS)',
      geographic_scope:
        'USDA-ARS Central Plains Experimental Range, Nunn, Colorado, USA',
      participant_age: '',
      project_goals:
        'Solving high priority problems as defined by customers through explicit integration and participation in all aspects of management-science co-production research. Efforts are truly integrative and present substantial opportunities for enhanced learning on tradeoffs and synergies of provision of multiple ecosystem services in semiarid rangelands.',
      participation_tasks:
        'Audio or Video Recording, Data Analysis, Data Entry, Finding Entities, Geolocation, Identification, Learning, Measurement, Observation, Photography, Problem Solving, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/trash-free-waters/best-management-practices-tools',
      project_description:
      ...
      participant_age: '',
      project_goals:
        "The goal of this project is to collect better data on trash loadings and a variety of other trash characteristics to inform potential upstream sources of trash in water using EPA's Escaped Trash Assessment Protocol (ETAP).",
...

    {
      ...
      participant_age: '',
      project_goals:
        'The aim of this project is to improve characterization of the surficial groundwater resources that are at greatest potential risk from waste disposal on the ground surface.',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Massachusetts, Maine, Connecticut, New Hampshire, Vermont, Rhode Island',
      participant_age: '',
      project_goals:
        'The goal of this project is to use data gathered by citizen science groups  to help EPA eliminate sanitary sewage from the stormwater system and upgrade stormwater infrastructure, thereby improving water quality in New England.',
      participation_tasks:
        'Data Analysis, Data Entry, Learning, Observation, Sample Analysis, Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Multiple Puerto Rico municipalities locations: Arecibo, Camuy, Ciales, Hatillo, Lares, Morovis, San Sebastian',
      participant_age: '',
      project_goals:
        'This project will increase radon monitoring capacity at the local level and inform planning decisions, including incorporation of radon-reducing features in building practices as part of the disaster recovery and rebuild effort.',
      participation_tasks:
        'Data Analysis, Data Entry, Geolocation, Observation',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://aaes.auburn.edu/alabamawaterwatch/related-projects/',
      project_description:
...

    {
      ...
      project_url_external:
        'https://www.inaturalist.org/projects/tribal-nations-botanical-research-collaborative',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Central Arizona (Apache-Sitgreaves, Coconino, Kaibab, and Tonto National Forests), Region 3',
      participant_age: '',
      project_goals:
        'The goal of the TNBRC is to collect data on traditionally used plants that are important to tribal communities to increase tribal community engagement in public lands management and strengthen conservation of traditional plants.',
      participation_tasks:
        'Classification or tagging, Observation, Photography',
      scistarter: '',
...

    {
      ...
      participant_age: '',
      project_goals:
        'To measure the distribution of American Pikas in the Columbia River Gorge, and to measure their recovery in post-fire conditions.',
      participation_tasks:
        'Data Entry, Finding Entities, Geolocation, Identification, Learning, Measurement, Observation, Photography',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://jhwildlife.org/our-work/nature-mapping/neighbors-to-nature-cache-creek-study/',
      project_description:
...

    {
      ...
      project_url_external:
        'https://www.fs.usda.gov/detail/hlcnf/workingtogether/volunteering/?cid=stelprdb5356661',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Helena-Lewis and Clark National Forest. Helena, Montana',
      participant_age: '',
      project_goals:
        'YFMP collects vital forest health monitoring data on National Forests while inspiring high school students to learn about local ecology, network with forest professionals, and make recommendations that impact forest management on their public lands.',
      participation_tasks:
        'Data Analysis, Data Entry, Finding Entities, Geolocation, Identification, Learning, Measurement, Observation, Photography, Problem Solving, Sample Analysis, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      participant_age: '',
      project_goals:
        'Facilitate the identification of gene expression signatures for various diseases and conditions by leveraging the collective expertise of the scientific community to efficiently annotate and group publicly available transcriptomic datasets',
      participation_tasks:
        'Annotation, Classification and Tagging, Data Analysis, Finding Entities, Sample Analysis',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/air-sensor-toolbox/air-sensor-loan-programs#r5',
      project_description:
...

    {
      ...
      project_url_on_catalog: 'https://www.citizenscience.gov/catalog/542/',
      project_url_external: 'https://www.epa.gov/participatory-science',
      project_description:
      ...
      keywords: '',
      fields_of_science:
        'Biology, Chemistry, Ecology and environment, Education, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope:
        'New York, New Jersey, Puerto Rico, US Virgin Islands, Cayuga Nation, Onondaga Nation, Oneida Indian Nation, Saint Regis Mohawk Tribe, Seneca Nation of Indians, Shinnecock Indian Nation, Tonawanda Seneca Nation, Tuscarora Nation',
      participant_age: '',
      project_goals:
        'The goal of this program is to allow collection of data by participatory science organizations, which can be used locally to better understand water pollution and protect water quality in local communities.',
      participation_tasks:
        'Data Analysis, Data Entry, Learning, Measurement, Observation, Problem Solving, Sample Analysis, Site Selection and/or Description',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/air-sensor-toolbox/air-sensor-loan-programs',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Multiple locations including Los Angeles in Region 9, tribal communities in Region 10, and rural and suburban communities in Region 5',
      participant_age: '',
      project_goals:
        "The goal of this project is to increase the number of air sensors available to communities, particularly in areas that might not otherwise have access to these tools, to build air pollution awareness and awareness around how to manage individual exposure to improve one's health and well-being.",
      participation_tasks: 'Data Entry, Observation',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Computers and technology, Geography, Geology and earth science, Nature and outdoors',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      geographic_scope:
        'GPS data are collected at thousands of geodetic control mark locations across the USA, and are then shared via on-line forms. Location lists can be generated via search at https://noaa.maps.arcgis.com/apps/webappviewer/index.html?id=6093dd81e9e94f7a9062e2fe5fb2f7f5',
      participant_age: '',
      project_goals:
        'The GPSonBM Program is designed to prepare communities across the country to take full advantage of the many benefits of the Modernized National Spatial Refence System when it is released.',
      participation_tasks:
        'Finding Entities, Geolocation, Measurement, Observation',
      scistarter: '',
...

    {
      ...
      fields_of_science:
        'Computers and technology, Ecology and environment, Geology and earth science, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: 'U.S. Department of the Interior (DOI)',
      geographic_scope:
        'Round 1 data submitted from the following locations: Browns Brook, Raymond, NH; Parkers Brook, Oakham, MA; Peavine Creek, Pokagon Township, MI; Additional locations to be added from EPA Regions 1, 2, 3, and 5 before completion of project.',
      participant_age: '',
      project_goals:
        'The goal of this project is to determine whether these streamflow images and hydrographs can be used together to understand how much the stream, including flow regime, changes over time. In the subsequent phase, computer vision machine learning will be tested as an approach to estimate flow from images, using the large number of images generated from partner organizations. The resulting tools may be applicable to protection of aquatic life from the impacts of hydrological alterations.',
      participation_tasks:
        'Data Analysis, Data Entry, Geolocation, Observation, Photography',
      scistarter: '',
...

    {
      ...
      project_url_external:
        'https://www.epa.gov/beach-tech/sanitary-surveys-recreational-waters#epa',
      project_description:
      ...
      fields_of_science:
        'Animals, Biology, Birds, Climate and weather, Computers and technology, Ecology and environment, Education, Geography, Nature and outdoors, Ocean/water and marine, Science policy',
      project_status: 'Active',
      agency_sponsor: 'U.S. Environmental Protection Agency (EPA)',
      agency_sponsor_other: '',
      geographic_scope: 'Nationwide',
      participant_age:
        'General public, Targeted group, People/organizations trained to conduct water quality monitoring',
      project_goals:
        'Using the App facilitates the identification of impaired recreational waters for remediation and for making same-day decisions on swim advisories.',
      participation_tasks:
        'Data Analysis, Data Entry, Geolocation, Identification, Learning, Measurement, Observation, Photography, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Targeted group, Youth/teen (up to 17)',
      project_goals:
        'Obtain baseline rates of deposition of beachcast marine bird and mammal carcasses to: assess causes of mortality, and inform resource management agencies of mortality events; build a network of interacting volunteers, scientists, and resource managers; and disseminate information to the public and educational institutions.',
      participation_tasks:
        'Classification or Tagging, Data Entry, Identification, Measurement, Observation, Photography, Specimen/Sample Collection',
      scistarter: '',
...

    {
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'Paddle the Gulf aims to network and showcase coastal paddle trails, also known as blueways, throughout the five US Gulf of Mexico States (Texas, Louisiana, Mississippi, Alabama and Florida), thereby enhancing public awareness and promoting stewardship of coastal resources.',
      participation_tasks:
        'Annotation, Audio or Video Recording, Finding Entities, Geolocation, Identification, Learning, Observation, Photography',
      scistarter: '',
...

    {
      ...
      participant_age: 'Targeted group',
      project_goals:
        'This project will help improve the accuracy of NOAA charts and publications.',
...

    {
      ...
      fields_of_science:
        'Climate and weather, Geology and earth science, Nature and outdoors',
      project_status: 'Active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      geographic_scope: '',
      participant_age:
        'Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'Crowdsourced reports of rain, snow, and mixed precipitation will help us and other scientists improve remote sensing products and hydrologic models to better estimate what type of precipitation falls during winter storms.',
      participation_tasks:
        'Classification or Tagging, Geolocation, Identification, Observation',
      scistarter: 'true',
...

    {
      ...
      fields_of_science:
        'Astronomy and space, Chemistry, Climate and weather, Physics',
      project_status: 'Active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      ...
      participant_age:
        'Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        "By creating a database of clouds high in Mars's atmosphere we can better understand how clouds form on Mars, what they're made of, and how they affect the climate.",
...

    {
      ...
      fields_of_science:
        'Astronomy and space, Climate and weather, Computers and technology, Education, Geology and earth science, Physics',
      project_status: 'Active',
      agency_sponsor:
        'National Aeronautics and Space Administration (NASA), National Science Foundation (NSF)',
      agency_sponsor_other: '',
      geographic_scope: 'Global',
      participant_age:
        'Families, General public, Middle school (11-13), Targeted group, Youth/teen (up to 17)',
      project_goals:
        'The objectives of HamSCI are to (1) advance scientific research and understanding through amateur radio activities, (2) encourage the development of new technologies to support this research, and (3) provide educational opportunities for the amateur community and the general public.',
      participation_tasks:
        'Audio or Video Recording, Classification or Tagging, Data Analysis, Identification, Learning, Measurement, Observation, Problem Solving',
      scistarter: 'true',
      email: '',
...

    {
      ...
      fields_of_science:
        'Chemistry, Disaster response, Ecology and environment, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'National Oceanic and Atmospheric Administration (NOAA)',
      agency_sponsor_other: '',
      ...
      participation_tasks:
        'Measurement, Observation, Site Selection and/or Description',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.kenaiwatershed.org/science-in-action/research-information/water-quality/',
      project_description:
      ...
      project_status: 'Active',
      agency_sponsor:
        'U.S. Environmental Protection Agency (EPA), U.S. Fish and Wildlife Service, U.S. Forest Service (USFS)',
      agency_sponsor_other: '',
      geographic_scope: 'Kenai Peninsula, Alaska',
      participant_age: 'General public',
      project_goals:
        "The Baseline Water Quality Monitoring Program project uses data to identify trends in and develop solutions for water quality challenges in Alaska's most popular river.",
      participation_tasks: 'Measurement, Observation',
      scistarter: 'true',
...

    {
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'The goal of this project is to build a database of coastal sediment characteristics from photos collected by citizen scientists.',
      participation_tasks:
        'Geolocation, Measurement, Observation, Photography, Specimen/Sample Collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.fisheries.noaa.gov/pacific-islands/honu-count-help-us-find-numbered-sea-turtles-hawaii#what-is-honu-count?',
      project_description:
      ...
      agency_sponsor_other: '',
      geographic_scope:
        'Main Hawaiian Islands; Oahu, Maui, Lanai, Molokai, Hawaii, Kauai, Niihau',
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'This valuable scientific information is used to track recently rehabilitated turtles, resident turtle habitat use, or when nesting turtles return back to their foraging grounds. We also use the data collected from Honu Count to determine the resilience of the Hawaiian green sea turtle in the face of climate change.',
      participation_tasks:
        'Data Entry, Geolocation, Learning, Observation, Photography',
      scistarter: 'true',
...

    {
      ...
      participant_age: 'Families, General public, Youth/teen (up to 17)',
      project_goals:
        "With your help, using data from small telescopes, Exoplanet Watch will make the best use of larger telescopes, discover new exoplanets, monitor changes in a star's brightness, and confirm recently discovered exoplanets.",
      participation_tasks:
        'Data Analysis, Learning, Observation, Photography, Sample Analysis',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://www.fisheries.noaa.gov/southeast/atlantic-highly-migratory-species/cooperative-tagging-program',
      project_description:
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Targeted group, Youth/teen (up to 17), Fishermen',
      project_goals:
        'To provide a long-term dataset of HMS species movement and distributions for use in stock assessments.',
      participation_tasks:
        'Classification or Tagging, Observation, Specimen/Sample Collection',
      scistarter: 'true',
...

    {
      ...
      project_url_external:
        'https://serc.si.edu/citizen-science/projects/chesapeake-water-watch',
      project_description:
      ...
      fields_of_science:
        'Astronomy and space, Biology, Chemistry, Climate and weather, Computers and technology, Ecology and environment, Geology and earth science, Nature and outdoors, Ocean/water and marine',
      project_status: 'Active',
      agency_sponsor: 'National Aeronautics and Space Administration (NASA)',
      agency_sponsor_other: '',
      ...
      participant_age:
        'Elementary school (6-10), Families, General public, Middle school (11-13), Youth/teen (up to 17)',
      project_goals:
        'Chesapeake Water Watch seeks to use remote sensing to fill in water monitoring gaps in the Chesapeake Bay.',
      participation_tasks:
        'Data Analysis, Data Entry, Geolocation, Identification, Learning, Measurement, Observation, Problem Solving, Sample Analysis, Site Selection and/or Description, Specimen/Sample Collection',
      scistarter: 'true',
...
const keywords = new Set(
  data._project
    .flatMap((p) => p.keywords.toLowerCase().split(", ")),
);
const fields_of_science = new Set(
  data._project.flatMap((p) => p.fields_of_science.toLowerCase().split(',')),
);
const participant_age = new Set(
  data._project.flatMap((p) => p.participant_age.toLowerCase().split(',')),
);
const participation_tasks = new Set(
  data._project.flatMap((p) => p.participation_tasks.toLowerCase().split(',')),
);

const project_status = new Set(
  data._project.map((p) => p.project_status.toLowerCase()),
);
const agency_sponsor = new Set(
  data._project.map((p) => p.agency_sponsor.toLowerCase()),
);
const agency_sponsor_other = new Set(
  data._project.map((p) => p.agency_sponsor_other.toLowerCase()),
);
const geographic_scope = new Set(
  data._project.map((p) => p.geographic_scope.toLowerCase()),
);



// console.log("keywords", Array.from(keywords).slice(0, 20));
// console.log("fields_of_science", Array.from(fields_of_science).slice(0, 20));
// console.log("participant_age", Array.from(participant_age).slice(0, 20));
// console.log("participation_tasks", Array.from(participation_tasks).slice(0, 20));
// console.log("project_status", Array.from(project_status).slice(0, 20));
// console.log("agency_sponsor", Array.from(agency_sponsor).slice(0, 20));
// console.log("agency_sponsor_other", Array.from(agency_sponsor_other).slice(0, 20));
// console.log("geographic_scope", Array.from(geographic_scope).slice(0, 20));

const spos =  `NOAA US EPA NASA BLM  NASA USFS US USGS NOAA US USGS NSF US EPA US USGS NSF US USGS US USGS NSF NPS NOAA NASA NOAA SI NOAA NSF US EPA  NASA NOAA US USGS NSF NPS SI NSF US DOI US USGS NPS US USGS BLM NPS NARA`

console.log(new Set(spos.split(" ")));